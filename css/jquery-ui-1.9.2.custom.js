...
* To view and modify this theme, visit http://jqueryui.com/themeroller/?ffDefault=Lucida%20Grande%2CLucida%20Sans%2CArial%2Csans-serif&fwDefault=normal&fsDefault=1.1em&cornerRadius=14px&bgColorHeader=3a8104&bgTextureHeader=03_highlight_soft.png&bgImgOpacityHeader=33&borderColorHeader=3f7506&fcHeader=ffffff&iconColorHeader=ffffff&bgColorContent=285c00&bgTextureContent=05_inset_soft.png&bgImgOpacityContent=10&borderColorContent=72b42d&fcContent=ffffff&iconColorContent=72b42d&bgColorDefault=4ca20b&bgTextureDefault=03_highlight_soft.png&bgImgOpacityDefault=60&borderColorDefault=45930b&fcDefault=ffffff&iconColorDefault=ffffff&bgColorHover=5ccb0b&bgTextureHover=03_highlight_soft.png&bgImgOpacityHover=50&borderColorHover=8bd83b&fcHover=ffffff&iconColorHover=ffffff&bgColorActive=285c00&bgTextureActive=04_highlight_hard.png&bgImgOpacityActive=30&borderColorActive=72b42d&fcActive=ffffff&iconColorActive=ffffff&bgColorHighlight=fbf5d0&bgTextureHighlight=02_glass.png&bgImgOpacityHighlight=55&borderColorHighlight=f9dd34&fcHighlight=363636&iconColorHighlight=4eb305&bgColorError=ffdc2e&bgTextureError=08_diagonals_thick.png&bgImgOpacityError=95&borderColorError=fad000&fcError=2b2b2b&iconColorError=cd0a0a&bgColorOverlay=444444&bgTextureOverlay=08_diagonals_thick.png&bgImgOpacityOverlay=15&opacityOverlay=30&bgColorShadow=344b43&bgTextureShadow=07_diagonals_small.png&bgImgOpacityShadow=40&opacityShadow=30&thicknessShadow=2px&offsetTopShadow=4px&offsetLeftShadow=4px&cornerRadiusShadow=14px
...
----------------------------------*/
.ui-widget { font-family: Josefin Sans,Lucida Sans,Arial,sans-serif; font-size: 1.1em; }
.ui-widget .ui-widget { font-size: 1em; }
.ui-widget input, .ui-widget select, .ui-widget textarea, .ui-widget button { font-family: Josefin Sans,Lucida Sans,Arial,sans-serif; font-size: 1em; }
...
.ui-state-hover, .ui-widget-content .ui-state-hover, .ui-widget-header .ui-state-hover, .ui-state-focus, .ui-widget-content .ui-state-focus, .ui-widget-header .ui-state-focus { border: 1px solid #8bd83b; background: #5ccb0b url(images/ui-bg_highlight-soft_50_5ccb0b_1x100.png) 50% 50% repeat-x; font-weight: normal; color: #ffffff; }
...
/* Overlays */
.ui-widget-overlay { background: #444444 url(images/ui-bg_diagonals-thick_15_444444_40x40.png) 50% 50% repeat; opacity: .3;filter:Alpha(Opacity=30); }
.ui-widget-shadow { margin: 4px 0 0 4px; padding: 2px; background: #344b43 url(images/ui-bg_diagonals-small_40_344b43_40x40.png) 50% 50% repeat; opacity: .3;filter:Alpha(Opacity=30); -moz-border-radius: 14px; -khtml-border-radius: 14px; -webkit-border-radius: 14px; border-radius: 14px; }


/* Default content and quick placement settings */
...
/* Locking down all slideshows across all devices */
/* Glitch prevention for mobile devices resizing issues */
...
/* Testing Area - These are very temporary or recent */
...
li {
    ...
    width: 100%;
    height: 18em;
    background-image: url("https://lh6.googleusercontent.com/-zSn6fcqW6sk/VNOmbbox58I/AAAAAAAABY8/1q0047MtEL0/s800/IMG_20150205_121659.jpg");
